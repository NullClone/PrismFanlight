...
namespace PrismFanlight.Timeline
{
    ...
    internal static class FanlightTimelineOverrideSchema
    {
        ...
        public static IReadOnlyList<FanlightTimelineOverrideDescriptor> GetGroup(FanlightTimelineSettingsGroup group)
        {
            return ByGroup[group];
        }

        public static bool TryGet(string path, out FanlightTimelineOverrideDescriptor descriptor)
        {
            return ByPath.TryGetValue(path, out descriptor);
        }

        public static IEnumerable<string> GetPaths(FanlightTimelineSettingsGroup group)
        {
            return ByGroup[group].Select(descriptor => descriptor.Path);
        }
    ...
    internal sealed class FanlightTimelineOverrideDescriptor
    {
        ...
        public FanlightTimelineBlendMode BlendMode { get; }
