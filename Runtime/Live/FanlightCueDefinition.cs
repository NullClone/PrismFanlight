...
namespace PrismFanlight.Live
{
    ...
    internal struct FanlightCueDefinition
    {
        ...
        [SerializeField] private FanlightShowPatch _patch;
        [SerializeField] private int _priority;
        [SerializeField] private double _attackSeconds;
        [SerializeField] private double _holdSeconds;
        [SerializeField] private double _releaseSeconds;
        [SerializeField] private FanlightCueRetriggerMode _retriggerMode;
