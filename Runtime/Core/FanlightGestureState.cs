...
namespace PrismFanlight.Core
{
    ...
    {
        [SerializeField] private string _gestureId;
        [SerializeField] private float _beatsPerCycle;
        [SerializeField] private float _phaseOffsetBeats;
        [SerializeField] private float _attackRatio;
        [SerializeField] private float _holdRatio;
        [SerializeField] private float _returnRatio;
        [SerializeField] private float _crispness;
        [SerializeField] private float _followThrough;
        [SerializeField] private float _downbeatAccent;
        ...
        {
            if (string.IsNullOrWhiteSpace(gestureId)) throw new ArgumentException("Gesture ID is required.", nameof(gestureId));
